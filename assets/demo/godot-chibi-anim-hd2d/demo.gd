...
const ANIMS = {
    "attack": { "frames": [preload("res://assets/attack_0.png"), preload("res://assets/attack_1.png"), preload("res://assets/attack_2.png")], "fps": 10, "loop": false },
    "back": { "frames": [preload("res://assets/back_3.png")], "fps": 4, "loop": true },
    "hurt": { "frames": [preload("res://assets/hurt_4.png"), preload("res://assets/hurt_5.png")], "fps": 10, "loop": false },
    "idle": { "frames": [preload("res://assets/idle_6.png"), preload("res://assets/idle_7.png")], "fps": 4, "loop": true },
    "walk": { "frames": [preload("res://assets/walk_8.png"), preload("res://assets/walk_9.png"), preload("res://assets/walk_10.png"), preload("res://assets/walk_11.png")], "fps": 8, "loop": true },
}
